    ...
    const fetchActiveQuest = async () => {
        ...
        try {
            ...
            if (res.ok && data) {
                ...
                console.error('Failed to fetch quest:', data);
            }
        } catch (err) {
    ...
    if (!activeQuest) {
        return (
            <div className="min-h-screen bg-background flex items-center justify-center">
                <EmptyState
                    icon="❓"
                    heading="No Active Quest Found"
                    description="Start by finding a match!"
                    action={
                                        ...
                                        <div className="flex justify-between items-start mb-2">
                                            <div className="flex-1">
                                                <h3 className="font-bold text-[10px] mb-1 font-pixel uppercase tracking-wider text-primary">
                                                    {isLocked ? "LOCKED" : "AI-GENERATED QUEST"}
                                                </h3>
                                            ...
                                            <div className="mt-3 pt-3 border-t-2 border-border">
                                                <div className="bg-orange-50 border border-orange-300 p-3">
                                                    ...
                                                    {challenge.partnerStatus.submissionImageBase64 && (
                                                        <img src={challenge.partnerStatus.submissionImageBase64} alt="Partner" className="h-24 mb-2 border-2 border-border" />
                                                    )}
