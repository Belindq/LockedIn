...
export function Button({
    ...
    const variantStyles = {
        primary:
            "bg-white text-primary border-2 border-primary hover:bg-primary hover:text-white dark:bg-primary dark:text-white dark:hover:bg-white dark:hover:text-primary rounded-lg",
        secondary:
